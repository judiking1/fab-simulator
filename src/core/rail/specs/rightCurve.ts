/**
 * RightCurveSpec — RIGHT_CURVE / CW_CURVE: QuadraticBezier CW arc.
 *
...
export const rightCurveSpec: CurveSpec = {
	type: RAIL_TYPE.RIGHT_CURVE,
	...
	generateCurve(from: Vector3, to: Vector3, options?: CurveOptions): Vector3[] {
		...
		const curvePoints = buildRightCurvePoints(originFrom, originTo, segments, curvature);
